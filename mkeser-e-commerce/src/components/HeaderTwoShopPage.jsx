...
function HeaderTwo({ widthT, textt }) {
  ...
  return (
    <>
      <div className="flex justify-center">
        ...
        >
          <div className={`flex justify-between items-center gap-48 `}>
            <h3 className="text-[%5] text-[#252B42] font-bold">Mu|Ge Style</h3>
            <div
          ...
          <div className="flex flex-row md:hidden gap-10">
            <IoPersonOutline className="min-w-4" size={24} />
            <IoSearch className="min-w-4" size={24} />
            <PiShoppingCart className="min-w-4" size={24} />
            <button onClick={toggleMenu} className="relative">
              <BiMenuAltRight className="cursor-pointer min-w-4" size={24} />
            </button>
          </div>
          <div className="hidden md:flex flex-col md:flex-row items-center gap-4 text-[#23A6F0]">
      ...
      <div className="md:hidden flex flex-col md:flex-row items-center gap-4 text-[#23A6F0]">
        <div className={`flex items-center ${textt} gap-1 cursor-pointer`}>
          <IoPersonOutline />
          <p>Login / Register</p>
        </div>
